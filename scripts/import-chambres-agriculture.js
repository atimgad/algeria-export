// scripts/import-chambres-agriculture.js
const fs = require('fs');
...
async function importFile(filePath) {
  console.log('🚀 Import CHAMBRES D\'AGRICULTURE...');
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        website: [],
        products: [],
        category: 'CHAMBRES D\'AGRICULTURE',
        entity_type: 'chamber',
        source_file: 'chambres_agriculture.txt'
      };
    } 
    else {
...
const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\SCRIPTS_UTILES\\chambres_agriculture.txt';
importFile(filePath);