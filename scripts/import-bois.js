...
const BATCH_NAME = 'batch_20260301_bois';
const CATEGORY = 'TRAVAIL DU BOIS & ARTICLES EN BOIS';
const ENTITY_TYPE = 'wood';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\r-TRAVAIL DU BOIS & ARTICLES EN BOIS.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        source_file: 'r-TRAVAIL DU BOIS & ARTICLES EN BOIS.txt'
      };
    } 
    else {
