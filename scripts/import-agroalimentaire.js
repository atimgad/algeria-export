// scripts/import-agroalimentaire.js
const fs = require('fs');
...
const BATCH_NAME = 'batch_20260301_agroalimentaire';
const CATEGORY = 'AGROALIMENTAIRE';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\q-AGROALIMENTAIRE.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        source_file: 'q-AGROALIMENTAIRE.txt'
      };
    } 
    else {
