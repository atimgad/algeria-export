// scripts/import-chambres-commerce.js
const fs = require('fs');
...
async function importFile(filePath) {
  console.log('🚀 Import CHAMBRES DE COMMERCE...');
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        website: [],
        products: [],
        category: 'CHAMBRES DE COMMERCE ET D\'INDUSTRIE',
        entity_type: 'chamber',
        source_file: 'chambres_commerce.txt'
      };
    } 
    else {
...
const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\SCRIPTS_UTILES\\chambres_commerce.txt';
importFile(filePath);