...
const BATCH_NAME = 'batch_20260301_chimique';
const CATEGORY = 'INDUSTRIE CHIMIQUE';
const ENTITY_TYPE = 'chemical';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\j-INDUSTRIE CHIMIQUE.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        source_file: 'j-INDUSTRIE CHIMIQUE.txt'
      };
    } 
    else {
