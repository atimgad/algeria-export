...
const BATCH_NAME = 'batch_20260301_aquaculture';
const CATEGORY = 'AQUACULTURE, ELEVAGE & PECHE';
const ENTITY_TYPE = 'fishing';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\p-Aquaculture, Elevage & Peche.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        source_file: 'p-Aquaculture, Elevage & Peche.txt'
      };
    } 
    else {
