...
const BATCH_NAME = 'batch_20260301_siderurgie';
const CATEGORY = 'SIDERURGIE & METALLURGIE';
const ENTITY_TYPE = 'steel';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\b-SIDERURGIE & METALLURGIE.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        source_file: 'b-SIDERURGIE & METALLURGIE.txt'
      };
    } 
    else {
