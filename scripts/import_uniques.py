...
print("="*80)
print("🏢 IMPORT DES 1249 ENTREPRISES UNIQUES")
print("="*80)
...
# Garder seulement les noms uniques (première occurrence)
...
for e in entreprises:
    ...
    if nom and nom not in noms_vus:
        ...
        # Entrée sans nom - on la garde quand même
        uniques.append(e)
