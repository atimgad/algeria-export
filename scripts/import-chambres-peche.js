// scripts/import-chambres-peche.js
const fs = require('fs');
...
async function importFile(filePath) {
  console.log('🚀 Import CHAMBRES DE PÊCHE...');
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        website: [],
        products: [],
        category: 'CHAMBRES DE LA PÊCHE ET DE L\'AQUACULTURE',
        entity_type: 'chamber',
        source_file: 'chambres_peche.txt'
      };
    } 
    else {
...
const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\SCRIPTS_UTILES\\chambres_peche.txt';
importFile(filePath);