// scripts/import-chambres-artisanat.js
const fs = require('fs');
...
async function importFile(filePath) {
  console.log('🚀 Import CHAMBRES D\'ARTISANAT...');
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        website: [],
        products: [],
        category: 'CHAMBRES D\'ARTISANAT ET DES METIERS',
        entity_type: 'chamber',
        source_file: 'chambres_artisanat.txt'
      };
    } 
    else {
...
const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\SCRIPTS_UTILES\\chambres_artisanat.txt';
importFile(filePath);