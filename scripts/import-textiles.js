...
const BATCH_NAME = 'batch_20260301_textiles';
const CATEGORY = 'TEXTILES, BONNETERIE & CONFECTION';
const ENTITY_TYPE = 'textile';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\a-TEXTILES, BONNETERIE & CONFECTION.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        source_file: 'a-TEXTILES, BONNETERIE & CONFECTION.txt'
      };
    } 
    else {
