...
const BATCH_NAME = 'batch_20260301_papier';
const CATEGORY = 'PAPIER & CARTONS';
const ENTITY_TYPE = 'paper';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\f-PAPIER & CARTONS.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        source_file: 'f-PAPIER & CARTONS.txt'
      };
    } 
    else {
