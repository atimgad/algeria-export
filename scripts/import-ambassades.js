  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        website: [],
        products: [],
        category: 'AMBASSADES D\'ALGERIE A L\'ETRANGER',
        entity_type: 'embassy',
        source_file: 'ambassades.txt'
      };
    } 
    else {
...
const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\SCRIPTS_UTILES\\ambassades.txt';
importFile(filePath);