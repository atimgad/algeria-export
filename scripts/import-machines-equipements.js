// scripts/import-machines-equipements.js
const fs = require('fs');
...
const BATCH_NAME = 'batch_20260301_machines';
const CATEGORY = 'MACHINES & EQUIPEMENTS';
const ENTITY_TYPE = 'machinery';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\h-MACHINES & EQUIPEMENTS.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        source_file: 'h-MACHINES & EQUIPEMENTS.txt'
      };
    } 
    else {
