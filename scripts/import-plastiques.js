...
const BATCH_NAME = 'batch_20260301_plastiques';
const CATEGORY = 'PLASTIQUES & CAOUTCHOUC';
const ENTITY_TYPE = 'plastic';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\e-PLASTIQUEs & CAOUTCHOUC.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        source_file: 'e-PLASTIQUEs & CAOUTCHOUC.txt'
      };
    } 
    else {
