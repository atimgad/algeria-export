...
const BATCH_NAME = 'batch_20260301_transport';
const CATEGORY = 'MATERIELS DE TRANSPORT';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\g-MATERIELS DE TRANSPORT.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        source_file: 'g-MATERIELS DE TRANSPORT.txt'
      };
    } 
    else {
