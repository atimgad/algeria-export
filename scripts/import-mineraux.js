...
const BATCH_NAME = 'batch_20260301_mineraux';
const CATEGORY = 'PRODUITS MINERAUX NON METALLIQUES';
const ENTITY_TYPE = 'minerals';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\d-PRODUITS MINERAUX NON METALLIQUES.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        source_file: 'd-PRODUITS MINERAUX NON METALLIQUES.txt'
      };
    } 
    else {
