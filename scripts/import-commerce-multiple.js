// scripts/import-commerce-multiple.js
const fs = require('fs');
...
const BATCH_NAME = 'batch_20260301_commerce_multiple';
const CATEGORY = 'COMMERCE MULTIPLE';
const ENTITY_TYPE = 'trading';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\n-COMMERCE MULTIPLE.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        source_file: 'n-COMMERCE MULTIPLE.txt'
      };
    } 
    else {
