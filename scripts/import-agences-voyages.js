// scripts/import-agences-voyages.js
const fs = require('fs');
...
async function importFile(filePath) {
  console.log('🚀 Import AGENCES DE VOYAGES...');
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        website: [],
        products: [],
        category: 'AGENCES DE VOYAGES',
        entity_type: 'travel',
        source_file: 'agences_voyages.txt'
      };
    } 
    else {
...
// Chemin du fichier
const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\SCRIPTS_UTILES\\agences_voyages.txt';
importFile(filePath);