// scripts/import-machines-electriques.js
const fs = require('fs');
...
const BATCH_NAME = 'batch_20260301_machines_electriques';
const CATEGORY = 'MACHINES & APPAREILS ELECTRIQUES';
const ENTITY_TYPE = 'electronics';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\i-MACHINES & APPAREILS ELECTRIQUES.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        source_file: 'i-MACHINES & APPAREILS ELECTRIQUES.txt'
      };
    } 
    else {
