// scripts/import-ambassades-algerie.js
const fs = require('fs');
...
async function importFile(filePath) {
  console.log('🚀 Import AMBASSADES EN ALGERIE...');
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        website: [],
        products: [],
        category: 'AMBASSADES EN ALGERIE',
        entity_type: 'embassy',
        source_file: 'ambassades_en_algerie.txt'
      };
    } 
    else {
...
const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\SCRIPTS_UTILES\\ambassades_en_algerie.txt';
importFile(filePath);