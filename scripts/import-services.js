...
const BATCH_NAME = 'batch_20260301_services';
const CATEGORY = 'SERVICES';
const ENTITY_TYPE = 'services';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\c-SERVICES.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      ...
      else if (line.startsWith('Produit:') || line.startsWith('Produits:')) {
