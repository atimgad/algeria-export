// scripts/import-energie-mines.js
const fs = require('fs');
...
const BATCH_NAME = 'batch_20260301_energie_mines';
const CATEGORY = 'ENERGIE & MINES';
const ENTITY_TYPE = 'energy';
...
async function importFile() {
  ...
  // CHEMIN DU FICHIER
  const filePath = 'C:\\Users\\User\\Documents\\ALGERIAEXPORT_FINAL\\DOCUMENTS\\l-ENERGIE & MINES.txt';
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    if (!currentEntity) {
      currentEntity = {
        ...
        source_file: 'l-ENERGIE & MINES.txt'
      };
    } 
    else {
