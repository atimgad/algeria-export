          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden md:flex items-center gap-1">
                ...
                <Link href={`/${lang}/adresses-utiles`} className="px-3 py-2 rounded-lg hover:bg-gray-100 flex items-center gap-2 text-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  ...
                  <li><Link href={`/${lang}/adresses-utiles`} className="hover:text-white">Adresses utiles</Link></li>
                </ul>
              </div>
