...
export default async function StrategicPillarsPage({ params: { lang } = { lang: 'fr' } }) {
  ...
  const pillars = [
    {
      ...
      description: "Renforcement de l'indépendance économique nationale par la diversification et la production locale.",
      color: "from-green-600 to-green-700"
    },
    {
      icon: <Globe2 className="w-8 h-8" />,
      title: "Rayonnement continental",
      description: "Positionner l'Algérie comme porte d'entrée de l'Afrique vers le monde et hub du commerce Sud-Sud.",
      color: "from-green-500 to-red-500"
    },
    {
      icon: <Factory className="w-8 h-8" />,
      title: "Industrie compétitive",
      description: "Développement d'une industrie nationale aux standards internationaux, capable d'exporter et de conquérir.",
      color: "from-red-500 to-red-600"
    },
    {
      icon: <GraduationCap className="w-8 h-8" />,
      title: "Capital humain",
      description: "Formation et développement des compétences algériennes pour l'économie du savoir.",
      color: "from-green-500 to-green-600"
    },
    {
      icon: <Leaf className="w-8 h-8" />,
      title: "Transition énergétique",
      description: "Développement des énergies renouvelables et de l'agriculture durable pour l'export.",
      color: "from-green-600 to-green-500"
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Sécurité alimentaire",
      description: "Garantir l'autosuffisance et développer une agriculture exportatrice de qualité.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      {/* Hero Section - CHARTE VERT/ROUGE */}
      <div className="bg-gradient-to-r from-green-900 to-red-900 text-white">
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              <span className="block">Algérie 2035</span>
              <span className="text-3xl md:text-4xl text-green-200">La vision d'une nation</span>
            </h1>
            <p className="text-xl text-green-100 max-w-3xl mx-auto">
              Cinq piliers stratégiques pour faire de l'Algérie la porte d'entrée 
              de l'Afrique vers le monde et un acteur majeur du commerce international.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            <span className="bg-gradient-to-r from-green-600 to-red-600 text-transparent bg-clip-text">
              Les 6 piliers de la stratégie 2035
            </span>
          </h2>
          ...
          <div className="mt-20 bg-white rounded-2xl shadow-xl p-12 border border-gray-100">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <div className="text-gray-600">Exportations hors hydrocarbures</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-green-600 mb-2">2000+</div>
                <div className="text-gray-600">Nouvelles entreprises exportatrices</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-green-600 mb-2">54</div>
                <div className="text-gray-600">Pays africains partenaires</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-green-600 mb-2">#1</div>
                <div className="text-gray-600">Hub numérique africain</div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-20 bg-gradient-to-r from-green-600 to-red-600 rounded-3xl p-12 text-center text-white">
            <h3 className="text-3xl font-bold mb-4">Rejoignez la dynamique 2035</h3>
            <p className="text-xl mb-8 text-green-100">
              Soyez acteur de la transformation économique de l'Algérie
            </p>
            <Link
              href={`/${lang}/register`}
